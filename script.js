  ...
  function seedDayPlans() {
    return {
      'Италия на машине': {
        ...
        '2026-08-12': { icon: '🏖', title: 'Отпуск: полдня Равенна + пляж', text: 'Начинаются 3 дня отпуска, не работаем.\n\nЧтобы не терять пляж — делаем Равенну лёгкой, на полдня: утром едем (~1 час), смотрим главные мозаики ЮНЕСКО (Сан-Витале, мавзолей Галлы Плацидии, Сант-Аполлинаре-Нуово) — это часа на 2–3.\n\nК обеду возвращаемся к морю: пляж, отдых, ужин у воды. Никакой спешки.' },
        '2026-08-13': { icon: '🏛', title: 'Отпуск: Флоренция (единственный «большой» день)', text: 'Честно: это самый НЕ-расслабленный день — 2,5–3 часа дороги в одну сторону, жара и много ходьбы. Один такой на поездку, ради Флоренции стоит.\n\nВыезжаем РАНО утром. Машину на парковку Villa Costanza (на въезде), в центр на трамвае (в центре на машине нельзя, штрафуют).\n\nСмотрим: собор Дуомо, мост Понте-Веккьо, под вечер — площадка Микеланджело (вид на весь город). Уффици — только по билетам онлайн заранее.\n\n👉 Если хочется МАКСИМУМ чила — Флоренцию можно вообще убрать (ты и так будешь в Италии ещё, а это отдельная поездка), и сделать этот день пляжным. Скажи — поменяю.' },
        '2026-08-14': { icon: '🏖', title: 'Отпуск: пляж, последний день в Романье', text: 'Чистый пляжный день без планов — то, ради чего всё и затевалось.\n\nМоре, долгий обед, прогулка. Если захочется движения — рядом замок Градара или крепость Сан-Лео (30–40 мин), но по желанию.\n\nВечером спокойно собираем вещи — завтра переезд под Рим.' },
