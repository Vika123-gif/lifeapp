  ...
  function seedDayPlans() {
    return {
      'Италия на машине': {
        ...
        '2026-08-13': { icon: '🏖', title: 'Пиза', text: 'Из Тосканы едем в Пизу (~1 ч от Флоренции).\n\nПлощадь Чудес (Campo dei Miracoli): падающая башня, собор, баптистерий — классические фото. Полдня хватает.\n\nПосле обеда — дорога дальше (см. вопрос ниже: возвращаемся в Романью или остаёмся в Тоскане).' },
        '2026-08-14': { icon: '🏖', title: 'День отдыха / пляж', text: 'Свободный день без броней — под чил.\n\nЕсли вернулись в Романью: море, пляж, отдых (можно заскочить в Равенну на мозаики, ~1 ч).\n\nЕсли остаётесь в Тоскане: расслабленный день в Кьянти (винодельни, Сан-Джиминьяно или Сиена) — но без спешки.\n\n👉 Зависит от того, где ночуете 13–15 (уточни — поправлю).' },
        '2026-08-15': { icon: '🏛', title: 'Переезд в Рим + пешая экскурсия 17:30', text: 'Едем в Рим и заселяемся на базу 2 (Via Monte Ceraso 24, Rocca Priora).\n\nЗабронировано: «Rome Central Free Walking Tour» — Треви, Пантеон, 11+ точек — суббота, 17:30, 2 взрослых (Best Euro Tours).\n\n⚠️ 15.08 Феррагосто + дорога: выезжаем с запасом, чтобы точно успеть к 17:30. Приезжаем, бросаем вещи — и на экскурсию.' },
