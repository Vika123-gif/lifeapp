  ...
  function seedDayPlans() {
    return {
      'Италия на машине': {
        ...
        '2026-08-15': { icon: '🚗', title: 'Переезд под Рим + вечерний Рим', text: 'Утром переезжаем на вторую базу: ~4 часа дороги.\n\nАдрес: Via Monte Ceraso 24, Rocca Priora (холмы под Римом, Кастелли-Романи).\n\n⚠️ Сегодня Феррагосто — главный летний праздник: магазины закрыты, трафик к морю. Поэтому выезжаем ПОРАНЬШЕ, продукты берём заранее.\n\nК вечеру заселяемся и, если есть силы, — первый выход в Рим на закате (до Рима ~40 мин). Главный день по Риму всё равно завтра, так что сегодня можно просто прогуляться без плана.' },
        '2026-08-16': { icon: '🏖', title: 'Рим — целый день', text: 'Главный день в Риме. Выезжаем рано (~40 мин), пока не жарко.\n\nКлассический маршрут по центру пешком: Колизей → Римский форум → площадь Венеции → Пантеон → площадь Навона → фонтан Треви → Испанская лестница.\n\nВ августе очень жарко: гуляем утром и вечером, в середине дня — длинный обед в тени. Вечером — район Трастевере (ужин, атмосфера).\n\nВ Ватикан/музеи — только по билетам онлайн заранее.' },
  ...
  const TRIP_MAPS = {
    'Италия на машине': {
      ...
      points: [
        ...
        { name: 'Рим', lat: 41.902, lon: 12.496, kind: 'day', day: '2026-08-16', label: 'Рим', anchor: 'end', dx: -7, dy: 3 },
        { name: 'Рим (вечер приезда)', lat: 41.905, lon: 12.482, kind: 'day', day: '2026-08-15' },
