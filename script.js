  ...
  function seedDayPlans() {
    return {
      'Италия на машине': {
        ...
        '2026-08-09': { icon: '🏖', title: 'Сан-Марино, вечером Римини', text: 'Первый спокойный день, всё рядом с домом.\n\nУтром едем в Сан-Марино (~30 мин) — государство на горе: крепости, панорамы, узкие улочки. Полдня хватит.\n\nВечером — старый центр Римини (мост Тиберия, площадь Кавур) или просто набережная и море.' },
        '2026-08-10': { icon: '💻', title: 'Работаем. Вечером — Сантарканджело', text: 'Днём работаем за ноутбуками на базе.\n\nПосле работы едем ужинать в Сантарканджело-ди-Романья (~15 мин) — маленький уютный старый город, хорошие остерии.' },
        '2026-08-11': { icon: '💻', title: 'Работаем. Вечером — море', text: 'Днём работаем.\n\nВечером едем к морю в Римини или Риччоне: аперитив на берегу, закат, прогулка.' },
        '2026-08-12': { icon: '🏖', title: 'Отпуск: едем в Равенну', text: 'С сегодняшнего дня 3 дня отпуска, не работаем.\n\nЕдем в Равенну (~1 час). Главное там — древние мозаики (ЮНЕСКО): базилика Сан-Витале, мавзолей Галлы Плацидии, Сант-Аполлинаре-Нуово. На город хватает полдня.\n\nВечер свободный.' },
        '2026-08-13': { icon: '🏖', title: 'Отпуск: Флоренция (большой день)', text: 'Самый дальний выезд — 2,5–3 часа в одну сторону, поэтому выезжаем РАНО утром.\n\nМашину оставляем на парковке Villa Costanza (на въезде) и едем в центр на трамвае — в центре на машине нельзя и штрафуют.\n\nСмотрим: собор Дуомо, мост Понте-Веккьо, под вечер поднимаемся на площадку Микеланджело (вид на весь город).\n\nЕсли хотим в галерею Уффици — билеты покупаем онлайн ЗАРАНЕЕ, на месте не попасть.' },
        '2026-08-14': { icon: '🏖', title: 'Отпуск: Болонья (или замки)', text: 'Едем в Болонью (~1 ч 15 мин): город портиков, две падающие башни, площадь Маджоре, обед в квартале Квадрилатеро (это гастрономический центр).\n\nЕсли после Флоренции устали — лёгкий вариант вместо Болоньи: замок Градара и крепость Сан-Лео (обе по 30–40 мин от базы) или просто пляж.' },
        '2026-08-15': { icon: '🚗', title: 'Переезд на базу 2 (под Рим)', text: 'Переезжаем на вторую базу: ~4 часа дороги.\n\nАдрес: Via Monte Ceraso 24, Rocca Priora (холмы под Римом, Кастелли-Романи).\n\n⚠️ Сегодня Феррагосто — главный летний праздник Италии: многое закрыто, все едут к морю. Поэтому выезжаем пораньше утром, продукты покупаем заранее или по дороге.' },
        '2026-08-16': { icon: '🏖', title: 'Обживаемся, озеро Альбано', text: 'Спокойное воскресенье без дальних поездок.\n\nДнём можно съездить на озеро Альбано покупаться (~15 мин).\n\nВечером прогулка по Кастель-Гандольфо (городок над озером, летняя резиденция Папы) или по Фраскати.' },
        ...
        '2026-08-19': { icon: '💻', title: 'Работаем. Вечером — Аричча', text: 'Рабочий день.\n\nВечером — Аричча, столица поркетты (запечёная свинина). Ужинаем во fraschette — простые семейные таверны: вино, мясо, сыры, всё по-домашнему.' },
        '2026-08-20': { icon: '💻', title: 'Работаем. Вечером — купание', text: 'Рабочий день.\n\nВечером снова к воде: купание в озере Альбано или прогулка в Кастель-Гандольфо.' },
        '2026-08-21': { icon: '💻', title: 'Последний рабочий день', text: 'Работаем последний день в поездке.\n\nВечер свободный: можно подняться в Рокка-ди-Папа или встретить закат на горе Монте-Каво. Или просто отдохнуть перед завтрашним Римом.' },
        '2026-08-22': { icon: '🏖', title: 'Большой день: Рим или Тиволи', text: 'Выбираем одно из двух (второе можно завтра):\n\nРИМ (~40 мин): выезжаем рано, идём по центру — Пантеон, площадь Навона, фонтан Треви, вечером район Трастевере (ужин). В августе жарко: лучше утро + вечер, днём длинный обед в тени.\n\nТИВОЛИ (~30 мин): вилла д’Эсте (сады с сотней фонтанов) + вилла Адриана (античная резиденция императора).' },
        '2026-08-23': { icon: '🏖', title: 'Последний день поездки', text: 'Едем туда, куда не поехали вчера (Рим или Тиволи), — или просто спокойное утро у озера.\n\nВечером собираем вещи.\n\n❓ Открытый вопрос: выезжаем домой сегодня вечером или завтра утром? Скажи — впишу.' },
      },
    };
  }
